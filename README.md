...
waytinier currently offers window (xdg_toplevel) creation and drawing on buffers. it is bare by design. it shouldn't be hard to extend functionality though.  
